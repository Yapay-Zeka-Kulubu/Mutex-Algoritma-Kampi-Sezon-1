...
namespace libraryApp.backend.Migrations
{
    ...
    [Migration("20241007151215_ChangeSeedData")]
            ...
            modelBuilder.Entity("libraryApp.backend.Entity.BookPublishRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            confirmation = false,
                            pending = true,
                            requestDate = new DateOnly(2024, 10, 7),
                            userId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("libraryApp.backend.Entity.LoanRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            pending = true,
                            requestDate = new DateOnly(2024, 10, 7),
                            returnDate = new DateOnly(2024, 10, 14),
                            userId = 1
                        },
                        new
                        {
                            ...
                            pending = true,
                            requestDate = new DateOnly(2024, 10, 7),
                            returnDate = new DateOnly(2024, 10, 21),
                            userId = 2
                        },
                        new
                        {
                            ...
                            pending = true,
                            requestDate = new DateOnly(2024, 10, 7),
                            returnDate = new DateOnly(2024, 10, 28),
                            userId = 3
                        },
                        new
                        {
                            ...
                            pending = true,
                            requestDate = new DateOnly(2024, 10, 7),
                            returnDate = new DateOnly(2024, 11, 4),
                            userId = 4
                        },
                        new
                        {
                            ...
                            pending = true,
                            requestDate = new DateOnly(2024, 10, 7),
                            returnDate = new DateOnly(2024, 11, 6),
                            userId = 5
                        },
                        new
                        {
            ...
            modelBuilder.Entity("libraryApp.backend.Entity.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            recieverId = 2,
                            senderId = 1,
                            sendingDate = new DateOnly(2024, 10, 7),
                            title = "Greetings"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("libraryApp.backend.Entity.Point", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            earnDate = new DateOnly(2024, 10, 7),
                            point = 10,
                            userId = 1
                        },
                        new
                        {
                            id = 2,
                            earnDate = new DateOnly(2024, 10, 6),
                            point = 20,
                            userId = 1
                        },
                        new
                        {
                            id = 3,
                            earnDate = new DateOnly(2024, 10, 5),
                            point = 15,
                            userId = 2
                        },
                        new
                        {
                            id = 4,
                            earnDate = new DateOnly(2024, 10, 4),
                            point = 25,
                            userId = 2
                        },
                        new
                        {
                            id = 5,
                            earnDate = new DateOnly(2024, 10, 3),
                            point = 30,
                            userId = 3
                        },
                        new
            ...
            modelBuilder.Entity("libraryApp.backend.Entity.Punishment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fineAmount = 5,
                            isActive = true,
                            punishmentDate = new DateOnly(2024, 10, 7),
                            userId = 1
                        },
                        new
                        {
                            ...
                            fineAmount = 10,
                            isActive = true,
                            punishmentDate = new DateOnly(2024, 10, 6),
                            userId = 2
                        },
                        new
                        {
                            ...
                            fineAmount = 15,
                            isActive = false,
                            punishmentDate = new DateOnly(2024, 10, 5),
                            userId = 3
                        },
                        new
                        {
                            ...
                            fineAmount = 20,
                            isActive = true,
                            punishmentDate = new DateOnly(2024, 10, 4),
                            userId = 4
                        },
                        new
                        {
                            ...
                            fineAmount = 25,
                            isActive = false,
                            punishmentDate = new DateOnly(2024, 10, 3),
                            userId = 5
                        },
                        new
                        {
            ...
            modelBuilder.Entity("libraryApp.backend.Entity.RegisterRequest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            confirmation = true,
                            pending = false,
                            requestDate = new DateOnly(2024, 10, 6),
                            userId = 2
                        },
                        new
                        {
                            ...
                            confirmation = true,
                            pending = false,
                            requestDate = new DateOnly(2024, 10, 5),
                            userId = 3
                        },
                        new
                        {
                            ...
                            confirmation = true,
                            pending = false,
                            requestDate = new DateOnly(2024, 10, 4),
                            userId = 4
                        },
                        new
                        {
                            ...
                            confirmation = true,
                            pending = false,
                            requestDate = new DateOnly(2024, 10, 3),
                            userId = 5
                        },
                        new
                        {

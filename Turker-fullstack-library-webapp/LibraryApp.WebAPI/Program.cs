...
ISettingRepository? sp = ((IApplicationBuilder)app).ApplicationServices.CreateScope().ServiceProvider.GetService<ISettingRepository>();
if(sp != null) await SettingsHelper.InitSettingsFromDb(sp);
